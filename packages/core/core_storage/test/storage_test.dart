...
void main() {
  ...
  group('CacheManager Tests', () {
    ...
    test('should save and get cache', () async {
      ...
      final data = cache.getCache<String>('test_cache', (json) => json as String);
    ...
    test('should return null for expired cache', () async {
      ...
      final data = cache.getCache<String>('expired_cache', (json) => json as String);
      expect(data, null);
    });
    ...
    test('should save cache with custom duration', () async {
      ...
      final data = cache.getCache<String>('custom_cache', (json) => json as String);
      expect(data, 'test_data');
    });
    ...
    test('should remove cache', () async {
      ...
      expect(cache.getCache<String>('remove_cache', (json) => json as String), 'test_data');
      
      await cache.remove('remove_cache');
      expect(cache.getCache<String>('remove_cache', (json) => json as String), null);
    });
