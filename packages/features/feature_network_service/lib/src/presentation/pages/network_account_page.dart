...
class NetworkAccountPage extends ConsumerWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => ref.invalidate(networkAccountProvider),
            tooltip: '刷新',
          ),
        ],
      ),
  ...
  Widget _buildContent(
      BuildContext context, WidgetRef ref, NetworkAccount account) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.account_circle, size: 48, color: AppColors.primary),
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Text('账户余额', style: AppTextStyles.labelLarge),
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('流量统计', style: AppTextStyles.labelLarge),
            const SizedBox(height: 16),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('已用 ${account.usedTraffic.toStringAsFixed(2)} GB',
                    style: AppTextStyles.bodyMedium),
                Text('剩余 ${remaining.toStringAsFixed(2)} GB',
                    style: AppTextStyles.bodyMedium
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('套餐信息', style: AppTextStyles.labelLarge),
            const SizedBox(height: 12),
            _buildInfoRow('套餐名称', account.packageName),
            _buildInfoRow(
                '套餐价格', '¥${account.packagePrice.toStringAsFixed(2)}/月'),
            _buildInfoRow(
                '套餐流量', '${account.totalTraffic.toStringAsFixed(2)} GB/月'),
          ],
        ),
      ),
    );
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('快捷操作', style: AppTextStyles.labelLarge),
            const SizedBox(height: 12),
            _buildActionItem(
              icon: Icons.history,
              title: '流量使用历史',
