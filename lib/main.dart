...
void main() async {
  ...
  runZonedGuarded(
    () {
      runApp(
        ProviderScope(
          overrides: AppConfig.useMockData
              ? [
                  networkUseMockProvider.overrideWithValue(true),
                  campusInfoUseMockProvider.overrideWithValue(true),
                  academicUseMockProvider.overrideWithValue(true),
                  convenienceUseMockProvider.overrideWithValue(true),
                ]
              : [],
